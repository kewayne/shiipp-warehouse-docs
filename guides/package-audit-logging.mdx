...
In **v1.1.9**, we introduced a comprehensive Audit Logging system to explicitly track changes made to packages. This is particularly crucial for identifying edits made _after_ a package has already been synchronized with a courier API.
