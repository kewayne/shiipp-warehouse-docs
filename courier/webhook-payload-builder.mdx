...
description: "Use Shiipp's Payload Builder to customize outbound webhook JSON structure for package and manifest status events sent to your courier endpoints."
---
