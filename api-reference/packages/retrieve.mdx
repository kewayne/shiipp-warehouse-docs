---
title: "Retrieve and Filter Packages via API"
sidebarTitle: "List Packages"
description: "POST /api/RetrievePackages.php — query, filter, and paginate packages. Supports export to CSV and XLSX. JWT Bearer token required."
---
