---
title: "Update Package Fields via the Shiipp Warehouse API"
sidebarTitle: "Update Package"
description: "POST /api/UpdatePackage.php — update package fields like weight, tracking number, and customer assignment. After update, the package is marked for re-sync."
---
