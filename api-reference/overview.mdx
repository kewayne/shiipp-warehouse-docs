---
title: "Shiipp REST API — Reference Overview"
...
<CardGroup cols={2}>
  ...
  <Card title="Packages" icon="box" href="/api-reference/packages">
  ...
  <Card title="Manifests" icon="file-lines" href="/api-reference/manifests">
  ...
  <Card title="Courier Settings" icon="gear" href="/api-reference/courier-settings">
