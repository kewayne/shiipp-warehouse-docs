---
title: "Bulk Import Customers from a CSV File"
sidebarTitle: "Upload Customers"
description: "POST /api/UploadCustomers.php — upload a CSV file to add or update customer records in bulk. Requires customer:add permission."
---
