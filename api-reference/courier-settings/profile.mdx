---
title: "Courier Profile: Get, Update, and Rotate API Keys"
...
```json
{
  ...
  "data": {
    ...
    "courier_name": "SkyDrop Logistics",
    "company_name": "SkyDrop Ltd.",
    "email": "ops@skydrop.com",
    "phone_number1": "+1-876-555-0100",
    "api_key": "your_current_api_key",
    "api_url_get_customers": "https://skydrop.com/api/customers",
    "api_url_add_package": "https://skydrop.com/webhook/package",
    "api_url_update_package": "https://skydrop.com/webhook/status",
