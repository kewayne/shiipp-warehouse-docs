---
title: "Prealerts: Advance Notice Before Package Arrival"
sidebarTitle: "Prealerts"
description: "Prealerts let courier partners notify Shiipp about incoming packages before they arrive at the warehouse, enabling faster processing and automatic data prefill."
---
...
<Note>
  The transition from **pending** to **received** happens automatically when a matching tracking number is logged. You do not need to manually update the prealert status in the normal workflow.
</Note>
