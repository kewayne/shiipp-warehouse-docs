---
title: "Understanding User Roles and Permissions in Shiipp"
sidebarTitle: "Roles"
description: "Shiipp uses role-based access control. Learn what each role — admin, manager, warehouse, and courier — can see and do across the platform."
---
